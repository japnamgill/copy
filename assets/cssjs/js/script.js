...
! function(t) {
                    ...
                    switch (u) {
                        case it:
                            var s = r.config,
                                ...
                                h = n.widthValue,
                                E = n.heightValue;
                            void 0 !== h && (d === W && (d = "px"), xt(t, L, o), a(t, L, h + d)), void 0 !== E && (v === W && (v = "px"), xt(t, P, o), a(t, P, E + v));
                            break;
                        case rt:
                            ! function(t, e, n, r) {
    ...
    var f = s(n(270)),
        ...
        dt = Object.freeze((i = {}, (0, c.default)(i, _.TRANSFORM_PREFIXED, I), (0, c.default)(i, D, y), (0, c.default)(i, N, N), (0, c.default)(i, C, C), (0, c.default)(i, L, L), (0, c.default)(i, P, P), i)),
        pt = {},
        vt = 1;
    var ht = 1;
    var Et = function(t, e) {
    ...
    function _t(t) {
        ...
        return null == N || null == C ? [] : _.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : x === F ? d(N, C) : x === k ? p(d(N)).filter(E(C)) : x === G ? h(d(N)).filter(E(C)) : d(C)
    }
    var mt = /px/,
        yt = function(t, e) {
        ...
        if (_.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    ...
                    a = i(t, V);
                if (a) {
                    var u = a.split(B).map(ft); - 1 === u.indexOf(r) && o(t, V, u.concat(r).join(B))
                } else o(t, V, r)
            }
        }
    }
        ...
        b = function(t, e) {
            ...
            if (_ && !y)
                for (var M = 0, j = a.length; M < j; M++) {
                    ...
                    for (var k = (w - I) / b, G = _.config.easing, X = h(G, k, f), U = 0, V = a.length; U < V; U++) {
                        var W = a[U],
                            B = m(s, W, _.config),
    ...
    var c, s, f, l = u(n(30)),
        ...
        gt = (r = {}, (0, o.default)(r, R, vt()), (0, o.default)(r, x, ht()), (0, o.default)(r, S, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, P, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, N, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, V, {
    ...
    r.define("dropdown", t.exports = function(t, e) {
        ...
        function R(e, i) {
            ...
            }(f)), f.toggle.on(T, E), f.toggle.on(m, function(t) {
                var e = N(t, a);
                return function(r) {
                    if (!n) {
        ...
        function A(n, r) {
            ...
            s && "/" === s.attr("href") && null == s.attr("aria-label") && s.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(E), a.button.off(E), a.menu.off(E), x(a), u ? (R(a), a.el.on("setting" + E, function(t) {
                return function(n, r) {
                    r = r || {};
                    var i = l.width();
                    x(t), !0 === r.open && G(t, !0), !1 === r.open && U(t, !0), t.open && e.defer(function() {
                        i !== l.width() && C(t)
                    })
                }
            }(a))) : (! function(e) {
...
Webflow.require('ix2').init({
    "events": {
        "e-13": {
            ...
            "target": {
                ...
                "originalId": "2294a779-aaa0-0e88-0d0a-f52ce538b9de",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".link-button",
        ...
        "e-16": {
            ...
            "target": {
                "selector": ".accordion",
                "originalId": "61f6b12a5a4b688af90f4d2b|7706f4bf-33d0-ed3b-bc8d-b7c703a702de",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".accordion",
        ...
        "e-18": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "61f105b7d06b2c4488390e02|fe95bfce-3226-d526-a894-e2784c43f5eb",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-21": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "61f105b7d06b2c4488390e02|14c48f3e-9d1b-cf5e-bae2-321fc36881cc",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-23": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "61f105b7d06b2c4488390e02|8ffa2504-ba63-ebc4-b607-fc5c1a75c693",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-25": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "61f6b0cb52d296796a68df01|96bd7724-54f2-b8c6-cfe2-c366af93db9b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-27": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "61f6b10ac8885cc2cfba93fb|4f38023d-4987-fc95-928f-bfac9e247bb7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-29": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "61fe7d206f0b38633255d4dc|388ec5bb-c38c-dea0-2975-9ebed0e6b3ee",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-31": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "915dda05-bf85-3ad6-b8d3-3dc14e4e6b51",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
    ...
    "actionLists": {
        "a": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".underline",
                            "selectorGuids": ["67c751e3-8c43-29fc-ccf5-203341999d6e"]
                        },
                        "xValue": 0,
                        "locked": false
                    }
            ...
            "createdOn": 1643568264505
        },
        "a-2": {
            "id": "a-2",
            "title": "Hover out Underline",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "TRANSFORM_SCALE",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".plus",
                            "selectorGuids": ["747986a4-47eb-b60e-e2c3-f954c6d1c5f5"]
                        },
                        "zValue": 0,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["747986a4-47eb-b60e-e2c3-f954c6d1c5fb"]
                        },
                        "value": 0,
                        "unit": ""
                    }
        ...
        "a-5": {
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1617288800908
        },
        "a-3": {
            "id": "a-3",
            "title": "Move Column Images",
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "61f105b7d06b2c4488390e02|fe95bfce-3226-d526-a894-e2784c43f5ec"
                            },
                            "yValue": -52,
                            "xUnit": "PX",
                            "yUnit": "%",
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "61f105b7d06b2c4488390e02|fe95bfce-3226-d526-a894-e2784c43f5f0"
                            },
                            "yValue": 0,
                            "xUnit": "PX",
                            "yUnit": "%",
        ...
        "a-8": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["90b1f792-9b27-aa60-9675-e25a4a78a027"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1644171929137
        },
        "a-9": {
            "id": "a-9",
            "title": "Hover Out Project",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-9-n",
                    "actionTypeId": "TRANSFORM_SCALE",
        ...
        "a-6": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".image",
                            "selectorGuids": ["e0f22954-db17-8851-eaeb-c0ee0b9e55f7"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1644171597506
        },
        "a-7": {
            "id": "a-7",
            "title": "Hover Out Image",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-7-n",
                    "actionTypeId": "TRANSFORM_SCALE",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["55b5b997-7111-b7bc-d075-41d0bf5f0892"]
                        },
                        "yValue": 0,
                        "xUnit": "PX",
                        "yUnit": "px",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["55b5b997-7111-b7bc-d075-41d0bf5f0893"]
                        },
                        "value": 1,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["55b5b997-7111-b7bc-d075-41d0bf5f0894"]
                        },
                        "yValue": 0,
                        "xUnit": "PX",
                        "yUnit": "px",
